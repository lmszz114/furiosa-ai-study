...
hist = model.fit(x_train, y_train, verbose=1, epochs=100, batch_size=32, validation_split=0.2)
...
러닝레이트 적용
learning_rate = 0.01
loss =  0.5423715710639954
RMSE =  0.736458979127496

learning_rate = 0.0001
loss =  0.541013240814209
RMSE =  0.7355360261591385

learning_rate = 0.005 ★갱신★
